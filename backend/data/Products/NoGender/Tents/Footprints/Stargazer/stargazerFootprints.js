...
export const stargazer3Footprint =
//============================================================================================================================
//                                                Next Product - Stargazer Tent
//============================================================================================================================
{
  // user: xxxx, //will be inserted with seeder script
  isRetired: false,
  name: 'Stargazer 3 Tent Footprint',
  images: [
    {
      color: 'Blue',
      colorImages: [
        {
          source: '/images/ProductImages/Tents/Footprints/stargazer3Footprint.jpg',
          isPrimaryImage: true,
        }
      ]
    },
  ...
  descriptions: [
    `Cut specifically to match your Stargazer 3 Tent, this durable water-resistant footprint adds an additional layer of protection from rocks and ground moisture.`
  ],
  features: [
    ...
    `Dimensions: 64.75'W x 88.75'L`,
  ],
  care: [`Do not wash or bleach. Spot clean with warm water and mild detergent. Air dry. Do not dry clean.`],
  materials: [ `100% nylon taffeta with polyurethane coating`, `Imported` ],
  reviews: [], //come back to this
  rating: 0,
  numReviews: 0,
  featureIcons: [
