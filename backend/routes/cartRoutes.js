...
import { getCart, addCartItem, deleteCartItem, updateCartQty, updateWholeCart, toggleSavedForLater } from '../controllers/cartController.js';
import { protect } from '../middleware/authMiddleware.js';

// Root url: /api/users/cart
router.route('/cartitem').post(protect, addCartItem).put(protect, updateCartQty);
router.route('/savedforlater').put(protect, toggleSavedForLater);
