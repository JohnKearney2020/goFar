...
const WishListRow = ({ 
  ...
  //     if(hasSizes === false){
  //       defaultSalePrice !== 0 ? setcurrentPrice(addDecimals(defaultSalePrice)) : setcurrentPrice(addDecimals(defaultPrice));
  ...
  //       setqtyAvailable(qtyInStock); // For the Qty Available column
  //       colorSalePrice === 0 ? setcurrentPrice(addDecimals(sizeCatDefaultPrice)) : setcurrentPrice(addDecimals(colorSalePrice)); // For the price column
  //     }
  //   }
